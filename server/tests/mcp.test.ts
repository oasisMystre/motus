...
describe("mcp", () => {
  ...
  test("get tokens", async () => {
    ...
    const response = await run(agent, '{"user": "4e3a430c-022a-45a2-ab1c-24bae2dc48eb",",questions":{"weight":[{"question":"What are your reasons for wanting to gain weight","answer":[{"name":"Gain muscle for general fitness"}]},{"question":"What is your weekly goal","answer":[{"name":"Loss 0.5kg per week"}]}]}} update-goal');
